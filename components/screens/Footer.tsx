...
import Orb from '@/app/components/Backgrounds/Orb/Orb'
  ...
  return (
    <>
      <div style={{ width: '100%', height: '100vh', position: 'relative' }}>
        ...
        />
        <footer className="absolute top-2 w-full px-4 py-10 text-black transition-colors duration-500 group-hover:bg-[#fceef9] sm:px-6 md:px-10 lg:px-20">
          {/* Top Section */}
          ...
          <div className="space-y-12">
            ...
            <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 md:ml-[16.3%] lg:grid-cols-3">
              {/* Column 1 */}
              <div className="">
                <p className="mb-3 font-semibold text-gray-200">Wordpress</p>
                {[
                  {
                    name: 'The Fallen',
                    img: '/images/ventures/the fallen.png',
                  },
                  {
                  ...
                  {
                    name: 'Flash Zone',
                    img: '/images/ventures/flash zone.png',
                  },
                  { name: 'Simula', img: '/images/ventures/simula.png' },
                ].map((item) => (
                  <div
                    key={item.name}
                    className="mt-3 flex items-center gap-2 rounded-lg p-2 text-lg font-medium text-gray-200 "
                  >
                    <img
                      src={item.img}
                      alt={item.name}
              ...
              {/* Column 2 */}
              <div>
                <p className="mb-3 font-semibold text-gray-200">Dashboards</p>
                {[
              ...
              {/* Column 3 */}
              <div>
                <p className="mb-3 font-semibold text-gray-200">Mobile Apps</p>
                {[
                  {
                    name: 'Good Garms',
                    img: '/images/ventures/good-garms.jpg',
                  },
            ...
            <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 md:ml-[16.3%] lg:grid-cols-3">
              ...
              <div>
                ...
                {['Freelance Things', 'Good Garms', 'A1'].map((item) => (
                  <div
                    key={item}
                    className="mt-1 rounded-lg p-2 text-lg font-medium  text-gray-200"
                  >
              ...
              <div>
                ...
                {['Twitter (X)', 'Instagram', 'LinkedIn', 'Webflow'].map(
                  (item) => (
                    <div
                      key={item}
                      className="mt-1 rounded-lg p-2 text-lg font-medium  text-gray-200"
              ...
              <div>
                ...
                {['Tools I use', 'Built in Webflow'].map((item) => (
                  <div
                    key={item}
                    className="mt-1 rounded-lg p-2 text-lg text-gray-200 font-medium "
                  >
                    {renderTextWithWave(item)}
                  </div>
                ))}
                {/* Footer Note */}
                <div className="text-m text-gray-200 mt-10 cursor-pointer rounded-lg p-2  ">
